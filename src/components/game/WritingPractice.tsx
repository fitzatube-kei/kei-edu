          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="text-center mb-4">
                {current.isFullWord ? (
                  <span
                    className="inline-block px-3 py-1 bg-[#B4D700] text-[#421785] rounded-full text-xs mb-2"
                    style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700 }}
                  >
                    Full Word
                  </span>
                ...
                {current.word.romanization && (
                  <p className="text-white/50 text-sm mt-0.5" style={{ fontFamily: 'Poppins, sans-serif' }}>
                    {current.word.romanization}
                  </p>
                )}
              </div>
