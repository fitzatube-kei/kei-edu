...
export default function KpopQuizPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-purple-50 pb-8">
      {/* Header */}
      <div className="sticky top-0 z-50 bg-gradient-to-b from-pink-50 to-transparent pt-4 pb-2 px-4 md:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {gameState === 'level-select' && (
            <>
              ...
              >
                <p className="text-[#FF7E00] text-[11px] uppercase tracking-wider mb-1" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700 }}>
                  YOUR PROGRESS
                </p>
                    ...
                    <motion.button
                      ...
                      className={`aspect-square rounded-2xl flex flex-col items-center justify-center relative transition-all shadow-md ${
                        isLocked
                          ...
                          : isCompleted
                            ? 'bg-[#FFF3E0] border-2 border-[#FF7E00]'
                        ...
                        <>
                          ...
                          <p
                            className={`text-[18px] sm:text-[22px] font-bold ${
                              isCompleted ? 'text-[#FF7E00]' : 'text-[#440687]'
                            }`}
                            style={{ fontFamily: 'Poppins, sans-serif' }}
                          >
                            #{index + 1}
                          ...
                          {/* Score if completed */}
                          {isCompleted && (
                            <div className="absolute top-1 right-1 flex items-center gap-0.5 bg-[#FF7E00] text-white px-1.5 py-0.5 rounded-full text-[10px] font-bold">
              ...
              {!isPremium && (
                <motion.div
                  ...
                  className="bg-gradient-to-r from-[#FF7E00] to-[#FF3D00] rounded-2xl p-4 mb-6 text-white"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <Link
                      href="/premium"
                      className="bg-white text-[#FF7E00] px-4 py-2 rounded-full text-[12px] font-bold"
                      style={{ fontFamily: 'Poppins, sans-serif' }}
                    >
                      Upgrade
                    </Link>
