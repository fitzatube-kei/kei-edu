    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-50 pb-8">
      ...
      <main className="px-4 md:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <motion.div
              className="w-[100px] h-[100px] sm:w-[120px] sm:h-[120px] rounded-2xl bg-gradient-to-br from-[#38B6FF] to-[#6366F1] flex items-center justify-center shadow-lg shrink-0"
