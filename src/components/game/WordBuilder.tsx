...
const categoryTranslations: Record<string, Record<string, string>> = {
  // English keys
  nature: { en: 'Nature', ko: '자연', ja: '自然', zh: '自然', th: 'ธรรมชาติ', vi: 'Thiên nhiên', es: 'Naturaleza' },
  animal: { en: 'Animal', ko: '동물', ja: '動物', zh: '动物', th: 'สัตว์', vi: 'Động vật', es: 'Animal' },
  food: { en: 'Food', ko: '음식', ja: '食べ物', zh: '食物', th: 'อาหาร', vi: 'Thức ăn', es: 'Comida' },
  body: { en: 'Body', ko: '신체', ja: '体', zh: '身体', th: 'ร่างกาย', vi: 'Cơ thể', es: 'Cuerpo' },
  family: { en: 'Family', ko: '가족', ja: '家族', zh: '家庭', th: 'ครอบครัว', vi: 'Gia đình', es: 'Familia' },
  object: { en: 'Object', ko: '물건', ja: '物', zh: '物品', th: 'วัตถุ', vi: 'Đồ vật', es: 'Objeto' },
  place: { en: 'Place', ko: '장소', ja: '場所', zh: '地点', th: 'สถานที่', vi: 'Địa điểm', es: 'Lugar' },
  vehicle: { en: 'Vehicle', ko: '교통', ja: '乗り物', zh: '交通', th: 'ยานพาหนะ', vi: 'Phương tiện', es: 'Vehículo' },
  color: { en: 'Color', ko: '색깔', ja: '色', zh: '颜色', th: 'สี', vi: 'Màu sắc', es: 'Color' },
  number: { en: 'Number', ko: '숫자', ja: '数字', zh: '数字', th: 'ตัวเลข', vi: 'Số', es: 'Número' },
  // Korean keys (for data that uses Korean categories)
  '자연': { en: 'Nature', ko: '자연', ja: '自然', zh: '自然', th: 'ธรรมชาติ', vi: 'Thiên nhiên', es: 'Naturaleza' },
  '동물': { en: 'Animal', ko: '동물', ja: '動物', zh: '动物', th: 'สัตว์', vi: 'Động vật', es: 'Animal' },
  '음식': { en: 'Food', ko: '음식', ja: '食べ物', zh: '食物', th: 'อาหาร', vi: 'Thức ăn', es: 'Comida' },
  '신체': { en: 'Body', ko: '신체', ja: '体', zh: '身体', th: 'ร่างกาย', vi: 'Cơ thể', es: 'Cuerpo' },
  '가족': { en: 'Family', ko: '가족', ja: '家族', zh: '家庭', th: 'ครอบครัว', vi: 'Gia đình', es: 'Familia' },
  '물건': { en: 'Object', ko: '물건', ja: '物', zh: '物品', th: 'วัตถุ', vi: 'Đồ vật', es: 'Objeto' },
  '장소': { en: 'Place', ko: '장소', ja: '場所', zh: '地点', th: 'สถานที่', vi: 'Địa điểm', es: 'Lugar' },
  '교통': { en: 'Vehicle', ko: '교통', ja: '乗り物', zh: '交通', th: 'ยานพาหนะ', vi: 'Phương tiện', es: 'Vehículo' },
  '색깔': { en: 'Color', ko: '색깔', ja: '色', zh: '颜色', th: 'สี', vi: 'Màu sắc', es: 'Color' },
  '숫자': { en: 'Number', ko: '숫자', ja: '数字', zh: '数字', th: 'ตัวเลข', vi: 'Số', es: 'Número' },
};
